            ...
            <div class="row row-top my-5 align-items-lg-center">
                ...
                <div class="col-lg-6 desc-product pl-lg-4">
                    ...
                    <div class="price"><span class="text-uppercase">Cena : </span> <span
                            class="prices"><?php echo $product->get_price();?></span> zł</div>
        ...
        <div class="buy-now mb-5">
            <div class="container">
                ...
                <div class="row-content__title text-center">
                    ...
                    <div class="sklad font-weight-bold text-uppercase h3">Produkt składa się z</div>
                    <ul class="my-4">
                    ...
                    <div class="price text-center">
                        <span class="text-uppercase">Cena : </span> <span class="prices"><?php echo $product->get_price();?></span> zł
                    </div>
                    <div class="add_to_card">
                        <div class="main-btn main-btn-yellow arrow mr-4">
                            <a href="/cart/?add-to-cart=<?php echo $product->get_id(); ?>">
                    ...
                    <div class="row row-loop">
                        <div class="col-lg-3">
                            <div class="single">
                                ...
                                <div class="prices"><?php echo $product->get_price();?> <span>zł</span></div>
                                <div class="addtocart">
                                    <div class="main-btn main-btn-yellow arrow mr-4">
                                        <a href="/cart/?add-to-cart=<?php echo $product->get_id(); ?>">
                                            Kup teraz
